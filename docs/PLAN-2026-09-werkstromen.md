...
|---|---|---|---|
| **AS** | Archief afronden (NAS) | Afrondend. **Deel 7 KLAAR 05-09:** `audit-volledig.mjs --hergebruik` op **18 punten = alleen AS 10** (18 inhoudsmappen zonder Synology-ACL, founder-vraag B72/AS 10.3); alle andere assen 0 [gemeten `audit/run-2026-09-05-deel7-na-1c.log`, 10:46]. NAS = Uscreen = 16.025/16.025, ontbrekend 0. AS 6 klaar 03-09, AS 9.2 klaar 05-09, AS 13 uitgevoerd 05-09 (`cf77eb9`), AS 1c gesloten 05-09, wachter-tempo `a4669fa`, B74/B75 `a6bb157`, B76 wrapper-guard (buiten repo) 05-09. **Deel 9+10 KLAAR 06-09 — AS-werkstroom AFGEROND voor alles wat zonder root kan:** nacht 6 sep exit 0 (52 min 3 s, 0× 429/pagina kwijt/TAB-GC), B78 6/6, B79 `da8760c` + fixes `88a3c66` (fail-closed collectie-details, allowlist collecties-vervallen.txt, TDZ-fix inhaal-pad), AS 10.3 202 objecten → A; audit 10:02: AS 1/5/7/11/12 = 0, **AS 10 = 9** (definitie nu = afwijkend van A; de 9 root:root-topmappen + inhoud vereisen root, zie §3.1). Tellers: B5 **1/3** (6 sep), AS 9.2 **3**. Doorlopend: wachter 04:15, back-up 03:30, B5-teller tot 3/3. | Nachten 7 en 8 sep (B5 2/3, 3/3); founder: root-actie voor de 9 topmappen + khatabi-bestand of AS 10 = 9 accepteren (B11-vraag); VRAAG: integratiebewijs wachter-tak, sanFallback ≠ san |

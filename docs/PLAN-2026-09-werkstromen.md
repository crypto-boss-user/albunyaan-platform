...
tweede ronde 2026-09-03: B7/B8/B12/B30 besloten, B28 + B1/B3 door Cowork gedaan, B9 en B29-bouwen open). **RV 0-antwoorden 2026-09-04: B46–B55; RV 1-keuring F1–F5 = B56–B60; MANDAAT founder 2026-09-04 = gouden regel 10 + B61–B71; RV 2 ingevoerd 2026-09-04; RV 2 KLAAR 2026-09-05 incl. `CLAUDE.md` (`96a86dd`, B73).** **Sessie K deel 1 (2026-09-08): K 1 keuzememo KLAAR (`docs/K1-kijkplatform-keuzememo-2026-09-08.md`, aanbeveling Bunny Stream opnieuw, gefaseerd) + één beslislijst voor founder/team/collega (`docs/BESLISLIJST-2026-09-08.md`, 15 + 8 + 4 punten; §5 verwijst ernaar); §2 kolom "Eerste actie" bijgewerkt.**
...
**Deel 9 (2026-09-06, sessie A):** nacht 6 sep gelezen (wachter exit 0, 52 min 3 s, 0× 429, 0× pagina kwijt, 0 TAB-GC → **B5 1/3**;
back-up exit 0 + NAS-kopie 3/3 → **AS 9.2 = 3**); **B79 gebouwd** (`da8760c`, T1): losmap ook in de 99-map, --dry herspeelt nu ook de
99-populatie (113 → 0 verschil); **B78 uitgevoerd** (6/6 op de NAS, sha 3/3 = vóór, inodes gelijk, covers/teksten via archive-extras,
manifest + structuur.jsonl bijgewerkt met kopieën); SR 4-assets 16/16 op de NAS. Details §3.1 (B78/B79) en §5.
...
|---|---|---|---|
| **AS** | Archief afronden (NAS) | Afrondend. **Deel 7 KLAAR 05-09:** `audit-volledig.mjs --hergebruik` op **18 punten = alleen AS 10** (18 inhoudsmappen zonder Synology-ACL, founder-vraag B72/AS 10.3); alle andere assen 0 [gemeten `audit/run-2026-09-05-deel7-na-1c.log`, 10:46]. NAS = Uscreen = 16.025/16.025, ontbrekend 0. AS 6 klaar 03-09, AS 9.2 klaar 05-09, AS 13 uitgevoerd 05-09 (`cf77eb9`), AS 1c gesloten 05-09, wachter-tempo `a4669fa`, B74/B75 `a6bb157`, B76 wrapper-guard (buiten repo) 05-09. **Deel 9+10+10b KLAAR 06-09 — AS-werkstroom AFGEROND (founder 06-09: AS 10 = 9 geaccepteerd als eindstand, B11 gesloten):** nacht 6 sep exit 0 (52 min 3 s, 0× 429/pagina kwijt/TAB-GC), B78 6/6, B79 `da8760c` + fixes `88a3c66` (fail-closed collectie-details, allowlist collecties-vervallen.txt, TDZ-fix inhaal-pad), AS 10.3 202 objecten → A; audit 10:02: AS 1/5/7/11/12 = 0, **AS 10 = 9** (definitie nu = afwijkend van A; de 9 root:root-topmappen met werkende ACL, DSM-actie optioneel, blokkeert niets). **Deel 10b: wachter op HEAD `391675b` live bewezen** — `--dry` via de wrapper 10:34–11:26 (52 min 12 s), exit 0, 0× 429/pagina kwijt/OVERGESLAGEN, 0 Error/TypeError/ReferenceError in de log, fouten-mac.log 495 → 495: 203 · 0 én 99-map 113 · 0. Tellers: B5 **1/3** (6 sep), AS 9.2 **3**. Doorlopend: wachter 04:15, back-up 03:30, B5-teller tot 3/3. | B5-teller **2/3** na nacht 7 sep (K 0 §1: exit 0, 6 nieuwe video's sha 6/6); nacht 8 sep = 3/3 → wachter-bewijs af, daarna alleen doorlopend (04:15-ronde, 03:30-back-up). Nieuw na K 1: wachter-stap "nieuwe video ook naar het kijkplatform" (T2, pas na de pilot — beslislijst F-1). Root-actie DSM optioneel; niet-blokkerende VRAGEN: fail-closed-tak bij een échte mislukte collectie-detailcall (nacht 7 sep raakte die tak niet), sanFallback ≠ san |
| **BS** | Bunny-stop-controle | Meetronde klaar (BS 0, Bijlage A). Open: launchd-restant, ruis, tellingen, tweede ⛔-ronde (incl. memory-map), half-doorgestreepte stuurdocumenten, VPS. | BS 1 ⛔-ronde repo + memory kan starten (B3/B4 besloten 03-09; Cowork deed het deel buiten de repo) — maar eerst beslislijst F-1/F-14 afwachten: bij "Bunny opnieuw" verandert de ⛔-tekst zelf. BS 2 wacht op de founder-bootout (B5); BS 4 op B7/B9 (termijn 2026-10-03, beslislijst F-2/F-3) |
| **SR** | Storefront-pariteit `apps/web` ↔ albunyaan.tv | **SR 0–SR 3 klaar 04-09; SR 4 deel 1 (stappen 1–5) gebouwd 05-09, deel 2 (stappen 7–11) gebouwd 05-09 — 20/20 tests, preview op de branch; poort = team-review per stap (B62); T2-grens zichtbaarheid gemeld (14.983 draft-video's)** (rapporten in `~/projects/_scratch/`, referentie in `reference/storefront-2026-09/` + NAS; open: SR 2b twin, SR 2c NL-IP, dan SR 3). Was: Repo heeft een 5-juli-referentie (`reference/real-site-ia.json`, 11 clone-PNG's) en een eigen skin ("saraev rebuild") [gemeten]. Geen SR-grondslag in docs/, CLAUDE.md, MASTER-PLAN, TODO of PROMPTS [gemeten, §7 T29]. | Teamreview deel 1 + 2 op de preview (B62) zodra het team erbij kan (beslislijst F-4) → zichtbaarheidsbeslissing T2 (F-5) → stap 6 na de Weglot-inlog (C-2) → stap 12 speler na de kijkplatform-pilot (F-1); SR 2c wacht op de NL-VPN (F-12) |
| **RV** | Review-voorzieningen + Playwright-baseline | **RV 0 klaar 03-09 · RV 1 uitgevoerd 04-09 (gekeurd F1–F5 = B56–B60) · RV 2 KLAAR 05-09 incl. CLAUDE.md** (5 commits `0df8a79`… 04-09 + `96a86dd` 05-09: Werkregels-blok + change-control-hunks, founder-akkoord incl. correctie Werkregel 1 = B73; commit-check bewezen live: rooktest geweigerd). **Deel 5 (05-09): B77 gedicht `6d1b3eb` (34/34 + 83/87, samengesteld commando live geweigerd); T18-diff klaar ter keuring `~/projects/_scratch/change-control-T18.diff`.** **Deel 6 (05-09): T18 toegepast `eb0a961` (founder-ja; + B5-notitie r42); B80 gedicht `f484be7` (B80-harness 35/61 → 76/76, B77 34/34, oud 83/87 = gelijk; `git -P commit`/`env git commit` live geweigerd) → hook = AF (founderbesluit 05-09: verdere bypass-vondsten alleen genoteerd).** Open: RV 0.6 collega, B19/B20. | Niets te bouwen: RV is af. Open = RV 0.6 collega-vraag (a) gstack (beslislijst C-1; (b)/(c) achterhaald door B19/B20) en de Codex-DEFER-/nazorgronde (beslislijst T-6) |
| **AD** | Admin-pariteit `apps/web/app/admin` ↔ Uscreen-admin (founderbesluit 2026-09-06: beheerdersdashboard voor het team = cutover-voorwaarde) | **AD 0 KLAAR 06-09** (meting, manifest 91 = NAS 91/91, inventaris + werklijst, B81–B83). **AD 1 deel 1 GEBOUWD 06-09 (sessie D):** stap 1 raamwerk `9ed99e7`, stap 2 Videos `0bfdb59`, stap 3 Collections/Categories/Resources/Custom Filters/Authors `08e0758`, stap 4 People `d6615e3`, stap 5 Coupons + Landing pages `3c77c59`; admin-test-account (TOTP, gitignored .env.local, runbook-regel); Playwright 20 storefront + 11 admin = 31/31 groen tegen next start :3012, build groen; per stap koude review + fixes (Review-log in elke commit); teamreview `reference/admin-2026-09/AD1-teamreview.md` (11 ja/nee-vragen NL/EN). **AD 1b UITGEVOERD 07-09 (B70):** founder-account `info@albunyaan.tv` = auth-user (magic-link-only) + `platform_admins` owner (telling 1 → 2); login-mail 2× door de Supabase-mailer geaccepteerd; flow na de klik bewezen op de preview met admin-test; handleiding `reference/admin-2026-09/AD1-inloggen.md` (NL/EN + 5 screenshots). **Blokkade voor de echte founder-login:** Supabase Site URL staat nog op `localhost:3000` (founder-runbook stap C, alleen founder). **AD 0b KLAAR 07-09 (B84):** Home/Subscriptions/Sales/Analytics 6/Settings gemeten (32 loads, 0× 429, 0 klikken; 24 cellen; manifest 68 = NAS 68/68); inventaris §2.4–§2.8, werklijst §8–§13 (WACHT 22 van 44), bouwvolgorde AD 2.1–2.5. **AD 2 UITGEVOERD 07-09 (sessie D deel 2, B85):** 2.1 Home `c5e5038` · 2.2 Settings `7024687` (migratie 0014 toegepast) · 2.3 Subscriptions `17e548a` (11 plannen geïmporteerd) · 2.4 Sales `aab30cb` · 2.5 Analytics `f50c408` · 2.6 inloglink `48fafb3`; 40 tests groen (`--workers=2`); teamreview `AD2-teamreview.md` (16 vragen); werklijst §14. | founder: Site URL (runbook C, beslislijst F-4) → klik de link → teamreview AD 1 + AD 2 (T-3/T-4, 27 vragen) → Codex-nazorg (T-5/T-6) → WACHT-rijen ontgrendelen per beslissing: KP na F-1, BT na F-9, MD na F-8, LM na F-10 |
| **K** | **Kijkplatformkeuze** (Bunny óf alternatief) | **K 0 meetronde KLAAR 2026-09-07 (sessie K deel 0, alleen lezen, 0 kosten):** archief 16.031 video's = **2,92 TB** / member_visible 15.171 = **2,71 TB** (B8, twee noemers); NAS-uplink **49,9 MB/s** (Cloudflare, 61 s) → archief in 0,68 dag / 0,63 dag; **80 % van de views (90 d) = 2.646 video's = 16,5 % / 17,4 %** (0,50 TB); live-kanalen **3,35 %** van de views maar Basmah TV Live = #1 item; kijk-apparaat niet meetbaar in Uscreen-analytics, proxy **54,7 % accounts via App Sign Up**. Rapport `~/projects/_scratch/K0-meetrapport-2026-09-07.md`. **K 1 keuzememo KLAAR 2026-09-08** (sessie K deel 1, `docs/K1-kijkplatform-keuzememo-2026-09-08.md`): gemeten bitrate **1,04 GB/kijkuur = 2,31 Mbit/s** (manifest × DB-duur, 15.840 video's) → egress ≈ **5 TB/maand**; archief ≈ 168.500 min, 80 %-set 26.400 min; vijf kandidaten geprijsd op 08-09; **aanbeveling: Bunny Stream opnieuw ($55–90/maand), gefaseerd, met de saldo-lessen ingebouwd**; zelf hosten = terugval; Cloudflare/api.video/Mux 10–20× duurder voor dit lange, weinig bekeken archief. Keuze = founder (§3.6, `docs/BESLISLIJST-2026-09-08.md` F-1/F-2). | founder: beslislijst F-1 (pilot Bunny, geld) + F-2 (live-pad B9, vóór 2026-10-03) → K 2 pilot 2 wk / 50 video's |
| — | **Leden-/DB-migratie** | **nog niet gepland** (bekende randvoorwaarden: §6 punt 27). **L 0-meetpunt 2026-09-07 [gemeten]:** Uscreen People 3.051 users (1.589 members · 2 one-time · 1.462 leads; 582 actief, 1.004 churned) vs Supabase `people` 2.928 → **ledengat 123** (zelfde als AD 1.4 op 06-09); DB `videos` 15.984 vs Uscreen 16.031 (delta-import hoort hier). | na beslislijst F-1 + F-9: her-export People (ledengat 123), delta-import 47 video's, demo-profielen (§6 punt 30) — beslislijst F-10 |
...
- **AS 10.3 Rechten-hygiëne als APARTE opruimactie** — Doel: voorspelbare rechten (doelvorm A:
  ...
  **UITGEVOERD 2026-09-06 (deel 10, go founder na droogloop, B11 = A) [gemeten]:** droogloop `_scratch/AS10-droogloop-2026-09-06.txt`
  = alle objecten onder de 18 "Linux mode"-inhoudsmappen die afwijken van A (755 mappen / 644 bestanden / mostafa:users / geen
  ACL): **205** (201 bestanden `-rwxrwxrwx+` van mostafa, 1 bestand 600, 1 bestand 666 van khatabi, 2 Synology-`@eaDir` van root);
  de 18 topmappen zelf waren al A. Preventie (B11) bewezen zonder codewijziging: `umask` via ssh = 0022 en alles wat de scripts
  vandaag maakten (B78-losmappen, covers, teksten) is 755/644 zonder ACL; `archive-fetch.sh` en de remote scripts van
  archive-extras doen `mkdir -p` onder die umask. Eén-object-test (18,8 MB, `synoacltool -del` → `----------+` → `chmod 644` →
  `-rw-r--r--`, Linux mode, sha256 gelijk, inode/nlink gelijk). Go: `as10-uitvoer-2026-09-06.sh` op de NAS onder nohup, alleen
  de 205 paden: **202 OK, 2 SKIP (@eaDir), 1 FOUT** (het khatabi-bestand: niet van mostafa, chmod onmogelijk zonder root).
  Nacontrole: sha256-steekproef 10/10 gelijk; bestanden 14.943 / inodes 11.296 vóór = na; afwijkers onder de 18 mappen 205 → **3**
  (khatabi-bestand, 2× @eaDir). **Audit-definitie omgedraaid (`88a3c66`):** AS 10 telde "zonder ACL" als het punt — het omgekeerde
  van B11 (A = Linux mode); nu "afwijkend van doelvorm A". Verwachting: de 9 inhoudsmappen `drwxrwxrwx root:root` + ACL (01, 02, 03,
  05, 06, 07, 10, 23, 99-Bijlagen) + werkmappen `_queue`/`done` apart. **Gemeten 10:02 (`audit/run-2026-09-06-deel10-na-as10.log`): AS 10 = 9 van 27 (exact die 9), onmeetbaar 0, werkmappen `_queue`/`done` apart; AS 1 16.025/16.025, AS 5/7/11/12 = 0 → TOTAAL 9.** Live `--dry` na de code (09:09–10:01, exit 0, 0× 429): 203 · 0 en 99-map 113 · 0.
  **Wat root vereist (founder, DSM/sudo — mostafa heeft geen sudo zonder wachtwoord):** die 9 topmappen (+ inhoud: ±700 ACL-objecten,
  eigenaar root op 30) omzetten naar A, het khatabi-bestand (09/18 Khalid ibn al-Walid, 2,0 GB) naar mostafa:users 644, en de
  2 `@eaDir` laten (Synology-metadata). Zonder die actie blijft AS 10 = 9 (topmappen) — een definitiekwestie, geen archiefgat:
  AS 1/5/7/11/12 = 0.
  **Deel 10b 2026-09-06 — AS-WERKSTROOM AFGEROND [gemeten]:** founder 06-09: **AS 10 = 9 geaccepteerd als eindstand** (root-topmappen
  met werkende ACL; DSM-actie optioneel, blokkeert niets) → B11 gesloten. Live `--dry` van de wachter op HEAD `391675b` (bevat
  `88a3c66`) via de wrapper onder nohup: 10:34:15–11:26:27 (**52 min 12 s**), exit 0 ("wachter klaar"), 16.025 video's, 0 nieuw,
  dekking 703 · 0 zonder archiefmap · 6 bewust leeg, volgorde 0 afwijkend (697 gecontroleerd), **herspeling 203 · 0 én 99-map
  113 · 0**, niets weggeschreven. Grep over het logblok op Error/TypeError/ReferenceError/cannot access = 0 treffers; 429/pagina
  kwijt/OVERGESLAGEN/inhaal/TAB-GC = 0; fouten-mac.log 495 → 495 regels; nohup-uitvoer 0 bytes; pidfile opgeruimd. Rooktest vooraf:
  `git commit -m "x"` op een schone boom → hook geweigerd. **Eerlijk:** hiermee is het pad "0 nieuwe video's" van HEAD live bewezen
  (inclusief de `let`-declaraties vóór de vroege exit uit de TDZ-fix); de fail-closed-tak bij een mislukte collectie-detailcall is
  niet live geraakt (er was geen nieuwe video) en blijft statisch + lib-tests (44/44) bewezen. Eindstand assen: AS 1 16.025/16.025,
  AS 5/7/11/12 = 0, AS 10 = 9 (geaccepteerd) → TOTAAL 9. Doorlopend: 04:15-ronde, 03:30-back-up, B5-teller tot 3/3 (nachten 7 en 8 sep).
...
**AD 0b — Meten voor AD 2: Home, Subscriptions, Sales, Analytics, Settings — KLAAR 2026-09-07 (sessie D deel 0b, scope B84).**
- Doel: de vijf resterende admin-secties vastleggen als norm, in dezelfde vorm als AD 0 (screenshot 1440 + HTML zwaar in `var/`, inventaris-JSON licht
  in `reference/admin-2026-09/ad0b-2026-09-07/`, manifest + sha256 + fouten.log, NAS-kopie).
- Gemeten: rooktest hook geweigerd; twin :9333 ingelogd; **32 loads, 0× 429, 0 STOP, 0 klikken** (alles via URL; `/subscription_plans/new` alleen
  geladen, controle daarna: nog 11 plannen, geen draft — B83); 24 cellen (Home 1 · Subscriptions 3 · Sales 2 · Analytics 6 · Settings 12);
  manifest 68 (24 PNG, 18 HTML, 24 tekst, 2 meta) lokaal = NAS `/volume1/Albunyaan/admin-referentie/ad0b-2026-09-07/` 68/68 gelijk.
- Privacy: facturenlijst en exported-files rijen volledig gezwart, factuurdetail alleen structuur, factuurnummer overal gezwart (kop/URL/manifest);
  Stripe-account-ID, PayPal-e-mail en Zapier-sleutel gezwart in screenshot + tekst; Omni-embed-URL (nonce/rollen) gezwart; HTML niet bewaard waar
  persoonsgegevens stonden (6 pagina's). Analytics = Omni-iframe: tegels/filters uit de iframe-tekst, screenshot alleen het zichtbare deel.
- Tellingen: plannen 11 (2 Public/9 Private, €3.50–€65.00, 592 leden, €487.92 MRR), facturen 3.134 (126 p., €30.478,81), Analytics 6 dashboards
  zonder exportknop, Settings 14 kaarten (10 + hub nu, 4 uit SR 2b). Eigen DB: `plans` 0, `subscriptions` 0, `entitlements` 0.
- Bewijs: `AD0-inventaris.md` §2.4–§2.8 + §4-rij + vragen 5–8; `AD-werklijst.md` §8–§13 (HEEFT 1 · WIJKT AF 7 · ONTBREEKT 9 · WACHT 22 · buiten 5;
  bouwvolgorde AD 2.1 Home → 2.2 Settings → 2.3 Subscriptions → 2.4 Sales → 2.5 Analytics). Scripts `~/projects/_scratch/ad0b-scripts-2026-09-07/`.
- Poort: founder-antwoord op vragen 5–8 (VOORBEELD-tegels, Settings-diepte, plannen-import, Sales als lege lijst). Tier: T0 (meting, docs-only).

**AD 2 — Home · Settings · Subscriptions · Sales · Analytics · inloglink — UITGEVOERD 2026-09-07 (sessie D deel 2, founder-antwoorden vraag 5–8 = B85).**
Stap 0: rooktest hook geweigerd; baseline build groen, Playwright 31/31 — alleen stabiel met `--workers=2` tegen `next start :3012` (4 workers → 6
timing-fouten); verouderde testserver van 6 sep op :3012 gestopt; 3 TEST-AD1-restanten van de mislukte run opgeruimd (3/3). Stap 1 Home `c5e5038`
(tegels, VOORBEELD-label alleen hier, zijmenu compleet). Stap 2 Settings `7024687` (hub 14 + Team, 16 subpagina's, migratie `0014_admin_settings`
toegepast via de pooler en geverifieerd: RLS aan/0 policies/anon leeg, verify-rls 21/21 zonder ledencheck). Stap 3 Subscriptions `17e548a` (T2,
volledige pipeline incl. adversarial; 11 plannen geïmporteerd 0 → 11, idempotent; guards op `stripe_price_id`). Stap 4 Sales `aab30cb`. Stap 5
Analytics `f50c408` (6 eigen pagina's, echte tellingen People/Content/Coupons, periode-filter). Stap 6 inloglink `48fafb3` (beheerder → /admin). Per stap koude review (subagent) + fixes, Review-log in elke commit; testrecords alleen `TEST-AD2-…` met opruimtelling (rest 0);
eindstand 40 tests groen (20 storefront + 20 admin, volledige eindrun 40/40), build groen. Teamreview `reference/admin-2026-09/AD2-teamreview.md` (16 vragen NL/EN);
werklijst §14. Open: alle BT/KP/MD/LM/DNS-rijen (met reden op de pagina); nazorg T0: `workers: 2` vastleggen, opruimhulp strenger.
...
**AD 1b — Beheerdersaccount founder + inloghandleiding — UITGEVOERD 2026-09-07 (sessie D deel 1b, founder-ja B70 op info@).**
Stap 0 rooktest geweigerd. Stap 1 gemeten vóór: auth-users 1 (admin-test), `platform_admins` 1, geen `people`-rij voor info@; login-mail gaat
via `signInWithOtp` → Supabase-mailer (geen eigen Resend-route); SMTP-instelling niet leesbaar (Management-token in `supabase-cli.env`
verlopen, 401 — founder vernieuwt); Resend-DNS voor albunyaan.tv staat (DKIM/MX/SPF via `dig`), verificatiestatus niet leesbaar (send-only
key); Site URL via `generate_link` = `http://localhost:3000`. Stap 2: auth-user info@ (e-mail bevestigd, geen wachtwoord, 0 factors) +
`platform_admins` owner → telling 2 = vóór + 1; signup-trigger 0003 maakte 1 `people`-rij (native). Stap 3 op de preview (bypass via
header, niet gelogd): aanvraag 1 geaccepteerd (`recovery_sent_at` 08:19:46Z), aanvraag 2 binnen 60 s → 429, aanvraag 3 "sent" (08:21:29Z);
aankomst niet meetbaar (Outlook-mailbox); flow na de klik met admin-test: `/auth/confirm` → `/admin` → `/admin/mfa` → TOTP → `/admin`,
`/admin/mfa/enroll` met factor → `/admin/mfa`. Stap 4 handleiding `reference/admin-2026-09/AD1-inloggen.md` + `ad1b-2026-09-07/` (5 screenshots,
adres gemaskeerd; geen enroll-QR-screenshot: had login als info@ of een extra account gevraagd = buiten mandaat). Runbook: admin-test weg
bij cutover, info@ blijft. **Onbewezen:** de klik van de founder; **blokkade:** de link in de mail wijst naar `localhost:3000` tot de founder
runbook stap C doet (Site URL, Redirect URLs, magic-link-template). Tier: T3 (auth, founder-ja), code ongewijzigd.
...
**K 1 — Eisen en kandidaten: KLAAR 2026-09-08 (sessie K deel 1, alleen lezen, 0 kosten; geen accounts, niets richting Bunny, niets geüpload).**
Memo `docs/K1-kijkplatform-keuzememo-2026-09-08.md`; beslissingen in `docs/BESLISLIJST-2026-09-08.md` (F-1 pilot, F-2 live, F-14 ⛔-blok).
1. **Nieuw gemeten:** gemiddelde bitrate van het archief **1,041 GB per kijkuur = 2,31 Mbit/s** [manifest.jsonl 16.031 video's × `videos.duration_seconds`
   gepagineerd; 15.840 gejoind = 2.882,6 GB / 9.967.700 s]; mediaan per video 2,13 Mbit/s (p10 0,86 · p90 3,63). Archief ≈ **2.808 u = 168.500 min**
   (191 manifest-video's zonder DB-duur bijgeschat); member_visible 15.171 = 2.620 u; **80 %-set 2.646 video's = 26.400 min = 0,503 TB**; 95 % = 66.200 min.
   Egress bij 4.821 kijkuur/maand ≈ **5,0 TB** (2×: 10 TB); geleverde minuten 289.260 (2×: 578.520).
2. **Elf eisen** (E1 per-video vullen gefaseerd · E2 opslag · E3 egress · E4 transcodering · E5 tokens · E6 web+apps/TV · E7 live · E8 EU · E9 opzegbaar ·
   E10 analytics · E11 nette stopzetting — de Bunny-les), elk met bron.
3. **Vijf kandidaten, prijzen gelezen 2026-09-08:** Bunny Stream ($0,01/GB opslag Frankfurt, CDN $0,010 Standard / $0,005 Volume per GB, encoding gratis,
   Fetch-API met headers, $1 minimum, live = preview [te meten]); Cloudflare Stream ($5/1.000 min opslag, $1/1.000 min levering, pagina 01-09-2026, geen
   EU-regiokeuze, live-opname verplicht); Mux ($0,0024–0,003/min opslag, $0,0008–0,001/min levering na 100k gratis, niet EU, live 12 u-limiet); api.video
   ($0,00285/min opslag, $0,0017/min levering, EU per project, live-prijs onbekend); zelf hosten (Hetzner Object Storage € 4,99 + € 4,99/TB [bron-verschil
   → te meten] + Bunny CDN, ffmpeg ≈ 24 dagen CPU [te meten]).
4. **Kosten vol archief per maand nu / 2×:** Bunny **$55–90 / $80–140** · zelf € 65–90 / € 115–140 · Mux $555–695 / $787–984 · api.video $972 / $1.464 ·
   Cloudflare $1.135 / $1.425. 80 %-set: Bunny $30–57, Mux $215–270, Cloudflare $425, api.video $567. Eenmalig vullen: $0 bij alle vier (encoding gratis/Basic);
   zelf = rekentijd. Pilot 2 wk / 50 video's: Bunny $1–2, Cloudflare ≈ $6, api.video $2–5, Mux $0–2, zelf ≈ € 6 + bouwtijd. Live: relay-VPS € 14,51 + egress;
   Cloudflare $29 + $864 opnames tenzij gewist; Mux $5.400; Bunny-preview/api.video [te meten].
5. **Rangorde:** 1 Bunny Stream · 2 zelf hosten (terugval) · 3 Cloudflare (live-hybride, E8 faalt) · 4 api.video · 5 Mux. **Aanbeveling:** Bunny opnieuw, nieuw
   account of verrekende heropening (saldo −$7,42), gefaseerd (80 %-set vóór de cutover, rest vóór de opzegging), met auto-recharge + 2FA + saldo-bewaker weer
   aan; live = aparte beslissing B9 (relay-VPS goedkoopst). Founder beslist: pilot (geld), EU-eis hard/zacht, live-pad, CDN-tier.
6. **Wat de keuze verandert (memo §5):** SR 4 stap 12 = HLS/embed met Bunny-token + nieuwe `bunny_video_id`'s + B22 ontdooien; poort 1 = "afspeelbaar id op
   het platform", fase 1 = 2.646/15.180; B9 gekoppeld aan B7 (termijn 2026-10-03); cutover-volgorde pilot → 80 %-set → stap 12 → leden → contentstop → rest →
   AS 6 → cutover, nieuwe poort "saldo-bewaker live"; wachter-stap naar het platform (T2); AD KP-rijen via Bunny Statistics; **CLAUDE.md-⛔-blok = founderbesluit
   + diff (gouden regel 6a)**.
- Bijvangst (geen actie): de banner "unpaid invoice" van 07-09 staat nog in het K 0-rapport hoewel B69 (04-09) "geregeld" zegt → beslislijst F-13.
- Niet gemeten: bytes ná transcodering, Bunny Live-preview, api.video-live-prijs, ingest-tempo, Hetzner-prijs (bron-verschil) → pilot/salesvraag (memo §6).

**K 2 — Pilot (2 weken, 50 video's): NOG NIET GEPLAND** — start alleen op founder-ja (geld: account + prepaid ≈ $10–20, beslislijst F-1).

Wat K 0 voor de keuze betekende (zonder te kiezen, rapport §5): opslag is bij
...
Overzicht (details per blok eronder). **Sinds 2026-09-08 is `docs/BESLISLIJST-2026-09-08.md` de bron voor alle open punten** (founder F-1…F-15, team T-1…T-8,
collega C-1…C-4; de drie meest blokkerende bovenaan: F-1 kijkplatform-pilot, F-2 live-pad vóór 2026-10-03, F-4 teamtoegang preview/admin). Nieuwe B-nummers
verwijzen daarnaar; onderstaande tabel blijft de historie.
...
| B11 | Rechten-doelvorm — **BESLOTEN 2026-09-03: A (755/644)** | founder | AS 10.3 (ontgrendeld) | **AS 10.3 UITGEVOERD 06-09 (deel 10)** voor alles wat mostafa mag: 202 objecten onder de 18 Linux-mode-mappen → A; rest vereist root: 9 topmappen root:root+ACL (+ ±700 objecten eronder), 1 khatabi-bestand; audit AS 10 nu = afwijkend van A (zie §3.1 AS 10.3). **Founder 2026-09-06: AS 10 = 9 geaccepteerd als eindstand** (root-mappen met werkende ACL; DSM-actie optioneel, blokkeert niets) → **B11 GESLOTEN**, AS-werkstroom afgerond (deel 10b, §3.1). |
...
| B70 | Beheerdersaccounts proefversie — **BESLOTEN 2026-09-04: later, vlak vóór de eerste SR 4-preview** — **UITGEVOERD 07-09 voor `info@albunyaan.tv`** (owner, magic-link-only; AD 1b in §3.5; handleiding `reference/admin-2026-09/AD1-inloggen.md`). Open bij de founder: Site URL/Redirect URLs/template in het Supabase-dashboard (founder-runbook C), daarna zelf de link klikken; Management-token vernieuwen. | founder | SR 4-preview |
...
| B84 | **AD-scope-uitbreiding (founder 2026-09-07):** AD 2 = Home (tegels met voorbeeldcijfers gelabeld VOORBEELD tot betaal-/kijkplatformkoppeling), Settings (alles behalve Website builder; geheime waarden nooit vastleggen of tonen), Analytics 6 (Overview, Content, People, Sales, Subscriptions, Marketing; niet Community/Advanced), Subscriptions en Sales als beheer zonder betaalkoppeling. Meting AD 0b uitgevoerd 07-09 (§3.5); bouwvolgorde AD 2.1 Home → 2.2 Settings → 2.3 Subscriptions → 2.4 Sales → 2.5 Analytics. Privacy als B82 + geen factuurnummers/bedragen per persoon. | founder | AD 2 | — **UITGEVOERD 07-09 (meting)** |
| B85 | **AD 2-antwoorden (founder 2026-09-07, inventaris-vragen 5–8):** (5) VOORBEELD-tegels alleen op Home met zichtbaar label "VOORBEELD" + tooltip; Analytics zonder voorbeeldcijfers — echt waar de DB het heeft, anders leeg met reden. (6) Settings: alle 14 kaarten met alle gemeten velden (behalve Website builder), opslaan via een settings-tabel (`admin_settings`, 0014), betalings-/Stripe-/PayPal-velden zichtbaar maar uit "tot de betaalbeslissing", secrets nooit tonen; Team = alleen tonen (T2). (7) De 11 plannen als data importeren (naam, prijs, valuta, interval, proef, Public/Private, volgorde), geen ledenkoppeling. (8) Sales als lege lijsten met de gemeten kolommen/filters, "tot de betaalbeslissing", geen voorbeeldrijen; Analytics = eigen pagina's met dezelfde tegels/tabs, geen iframe. | founder | AD 2 | **uitgevoerd 07-09** (commits c5e5038 · 7024687 · 17e548a · aab30cb · f50c408 · 48fafb3 + docs) |
...
opgezegd.
**K 1 2026-09-08:** aantal = 29 [gemeten K 0, T28 gesloten], 4 kanalen = 69 % van live; drie paden geprijsd (memo §3.2: relay-VPS € 14,51 + egress ·
Bunny Live-preview [te meten] · Cloudflare live $29 + $864 opnames tenzij gewist); beslislijst **F-2**.
...
**B78/B79 — founder-ja 05-09, uitgevoerd 06-09 (deel 9).** Zie de tabel. Blokkeert: niets.

**Deel 9 — stand 2026-09-06 (sessie A).** Nacht 6 sep [gemeten `archief-bijwerken.log`, `backup.log`, `launchctl list`]: wachter 04:15:04–05:07:07 = 52 min 3 s, LastExitStatus 0, 0× 429, 0× "pagina kwijt", 0 TAB-GC in alle logs (migration-watchdog uitgeladen sinds 05-09 08:26; laatste TAB-GC 05-09 04:19), 0 wrapper-weigeringen, Uscreen 16.025 / nieuw 0 (NAS-manifest 16.024 unieke video's = de bekende B8-noemer), dekking 703/0/6, volgorde 0 afwijkend → **B5 1/3**. Back-up 03:30 exit 0, 37/37 = count, 73.082 rijen, NAS-kopie 38/38 sha gelijk, 3 kopieën → **AS 9.2 = 3**. Sessie B's ssh-probe van ±05:00 kwam niet terug omdat macOS geen `timeout` heeft (commando faalde lokaal) en de tweede poging door de founder is afgebroken — niet de wachter, niet de NAS (ssh 05:28 in 1 s, NAS-loop draaide, wachtrij leeg). **Live bewijs na B78/B79:** wachter `--dry` via de wrapper 06:23:34–07:15:35 (52 min 1 s, exit 0, 0× 429, 0× pagina kwijt): "herspeling: 203 video's met een directe categorie · 0 verschil — het archief voldoet al" én "herspeling 99-map: 113 · 0 verschil" (een eerste poging 05:44 stierf om 06:09 mee met een door het systeem gestopte achtergrondtaak — geheugendruk op de Mac, niet de wachter; één verweesde uscreen-tab op :9333). Audit `--hergebruik` 07:16 (`audit/run-2026-09-06-deel9-na-b78.log`): AS 1 16.025/16.025, AS 5 = 0, AS 7 = 0, AS 11 0/0/0, AS 12 0 afwijkingen (inodes 18.271), **TOTAAL 18 = alleen AS 10** — gelijk aan deel 7/8. Manifest 18.422 regels (+10: 5 covers, 4 zoekwoorden, 1 beschrijving; 2 videoregels herschreven). Volgende: nacht 7 sep (B5 2/3), AS 5 = 0 bij de eerstvolgende nieuwe losse video; B79-review-vragen M-1/M-2.

...
Additional evidence sources (read-only): docs hub `~/projects/albunyaan-funnel/docs/` (program plan, decisions, PRDs); session memory `~/.claude/projects/-Users-a2020-Fable-5-PLAN/memory/albunyaan-platform-rebuild.md`.
